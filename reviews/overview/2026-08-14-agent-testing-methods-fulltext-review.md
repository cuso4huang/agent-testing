...
- 9 份开放 PDF：`literature/papers/2026-*.pdf` 中对应本轮文件，均通过 PDF 签名和 `pdfinfo` 检查。
- 9 份结构化全文笔记：`literature/notes/2026-*-*.md`。
- 证据与筛选：`literature/evidence/evidence-table.csv`、`screening-log.csv`。
- 核验引用：`literature/bibliography/references.bib`。
